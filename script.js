...
function buildNavbar() {
    ...
    cart.src = "https://www.pngkey.com/png/full/307-3071593_accessories-shopping-cart-icon-white.png";
...
function buildItemCard(name, numreview, price, imageUrl) {
...
// itemList.appendChild(newItemCard10);
